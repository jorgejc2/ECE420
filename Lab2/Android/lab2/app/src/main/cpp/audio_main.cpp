...
JNIEXPORT void JNICALL
        Java_com_ece420_lab2_MainActivity_createSLEngine(JNIEnv *env, jclass, jint, jint);
JNIEXPORT void JNICALL
...
Java_com_ece420_lab2_MainActivity_createSLBufferQueueAudioPlayer(JNIEnv *env, jclass type) {
