...
public class Img_hash {
    ...
    public static void marrHildrethHash(Mat inputArr, Mat outputArr)
    {
        ...
        marrHildrethHash_1(inputArr.nativeObj, outputArr.nativeObj);
    ...
    public static void radialVarianceHash(Mat inputArr, Mat outputArr)
    {
        ...
        radialVarianceHash_1(inputArr.nativeObj, outputArr.nativeObj);
    ...
    private static native void marrHildrethHash_1(long inputArr_nativeObj, long outputArr_nativeObj);
    ...
    private static native void radialVarianceHash_1(long inputArr_nativeObj, long outputArr_nativeObj);
