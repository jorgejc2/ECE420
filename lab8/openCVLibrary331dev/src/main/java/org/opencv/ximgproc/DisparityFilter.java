...
public class DisparityFilter extends Algorithm {
    ...
    public  void filter(Mat disparity_map_left, Mat left_view, Mat filtered_disparity_map)
    {
        ...
        filter_1(nativeObj, disparity_map_left.nativeObj, left_view.nativeObj, filtered_disparity_map.nativeObj);
    ...
    private static native void filter_1(long nativeObj, long disparity_map_left_nativeObj, long left_view_nativeObj, long filtered_disparity_map_nativeObj);
